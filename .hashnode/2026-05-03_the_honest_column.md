...
seo_description: "there is a class of CRM bug that is not a bug in the code. it is a bug in the design.  the code works exactly as written. the data is wrong. and the"
